 ...
 * Class dspSystem
 *
 * This class implements the processor implementation.
 *
 * It dispatches the audio stream to the different algorithms 
 * in one processing block.  
 */
